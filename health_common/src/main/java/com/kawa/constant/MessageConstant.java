package com.kawa.constant;

/**
 * 消息常量
 */
public class MessageConstant {
    public static final String WEIXIN_ORDER = "微信预约";
    public static final String TELEPHONE_ORDER = "电话预约";
    ...
    public static final String EIDT_SETMEAL_SUCCESS = "编辑套餐数据成功";
